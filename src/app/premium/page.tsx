...
export default function PremiumPage() {
  ...
  const renderToggleButtons = () => (
    <div className="absolute top-6 left-6 z-50 flex gap-2 bg-black/50 p-2 rounded-xl backdrop-blur-md flex-wrap max-w-[90vw] border border-white/10 shadow-2xl">
      <Link href="/premium" className={`px-4 py-2 rounded-lg text-sm font-bold transition-colors bg-[#ff4a1c] text-white shadow-[0_0_15px_rgba(255,74,28,0.4)]`}>{t('nav.premium_variant')}</Link>
